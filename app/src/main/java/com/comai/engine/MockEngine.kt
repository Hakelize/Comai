        ...
        return when {
            ...
            task.contains("recall") || task.contains("my work") || task.contains("my office") -> {
                ...
                if (!retrieved.isNullOrBlank()) {
                    ...
                    AIResponse(
                        action = "memory_recall",
                        speech = "I don't have any saved memories about you yet. You can tell me things like where you work or when you usually leave, and you can review or delete them anytime.",
                        displayText = "🧠 I don't remember any saved memories about you yet.\n\nYou can tell me things like:\n• \"I usually leave work around 5:30\"\n• \"I work at Tech Hub Office\"\n• \"I like calm music after work\"\n\n🔒 Everything stays on your device and can be deleted anytime.",
                        metadata = mapOf("scenario" to "memory_recall", "has_memories" to "false")
                    )
                }
            }

            // --- Priority 2: Specific Manual User Inquiries ---
            // Overtime / Late Office Check-in
            ...
            task.contains("morning_routine") || ((task.isBlank() || task == "greeting") && time == "morning") ->
                AIResponse(
                    action = "greeting",
            ...
            // --- General context ---
            task.contains("general") || task.contains("general_context") ->
                AIResponse(
                    action = "general",
                    ...
                    metadata = mapOf("scenario" to "general_context")
                )
